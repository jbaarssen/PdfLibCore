...
public struct FPDF_WIDESTRING : IHandle<FPDF_WIDESTRING>
{
    private IntPtr _pointer;
    public bool IsNull => _pointer == IntPtr.Zero;
    public static FPDF_WIDESTRING Null => new();
    private FPDF_WIDESTRING(IntPtr ptr) => _pointer = ptr;
    FPDF_WIDESTRING IHandle<FPDF_WIDESTRING>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FPDF_WIDESTRING: 0x{_pointer:X16}";
}