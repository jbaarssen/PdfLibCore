...
public struct FS_LPCPOINTF : IHandle<FS_LPCPOINTF>
{
    private IntPtr _pointer;
    public bool IsNull => _pointer == IntPtr.Zero;
    public static FS_LPCPOINTF Null => new();
    private FS_LPCPOINTF(IntPtr ptr) => _pointer = ptr;
    FS_LPCPOINTF IHandle<FS_LPCPOINTF>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FS_LPCPOINTF: 0x{_pointer:X16}";
}