...
public struct FS_LPRECTF : IHandle<FS_LPRECTF>
{
    private IntPtr _pointer;
    public bool IsNull => _pointer == IntPtr.Zero;
    public static FS_LPRECTF Null => new();
    private FS_LPRECTF(IntPtr ptr) => _pointer = ptr;
    FS_LPRECTF IHandle<FS_LPRECTF>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FS_LPRECTF: 0x{_pointer:X16}";
}