...
public struct FPDF_GLYPHPATH : IHandle<FPDF_GLYPHPATH>
{
    ...
    public static FPDF_GLYPHPATH Null => new();
    private FPDF_GLYPHPATH(IntPtr ptr) => _pointer = ptr;
    FPDF_GLYPHPATH IHandle<FPDF_GLYPHPATH>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FPDF_GLYPHPATH: 0x{_pointer:X16}";
}