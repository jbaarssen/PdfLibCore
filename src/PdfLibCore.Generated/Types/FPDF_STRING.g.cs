...
public struct FPDF_STRING : IHandle<FPDF_STRING>
{
    private IntPtr _pointer;
    public bool IsNull => _pointer == IntPtr.Zero;
    public static FPDF_STRING Null => new();
    private FPDF_STRING(IntPtr ptr) => _pointer = ptr;
    FPDF_STRING IHandle<FPDF_STRING>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FPDF_STRING: 0x{_pointer:X16}";
}