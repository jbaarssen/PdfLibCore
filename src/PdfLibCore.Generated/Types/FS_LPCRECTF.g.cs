...
public struct FS_LPCRECTF : IHandle<FS_LPCRECTF>
{
    private IntPtr _pointer;
    public bool IsNull => _pointer == IntPtr.Zero;
    public static FS_LPCRECTF Null => new();
    private FS_LPCRECTF(IntPtr ptr) => _pointer = ptr;
    FS_LPCRECTF IHandle<FS_LPCRECTF>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FS_LPCRECTF: 0x{_pointer:X16}";
}