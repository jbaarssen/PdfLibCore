...
public struct FPDF_SIGNATURE : IHandle<FPDF_SIGNATURE>
{
    ...
    public static FPDF_SIGNATURE Null => new();
    private FPDF_SIGNATURE(IntPtr ptr) => _pointer = ptr;
    FPDF_SIGNATURE IHandle<FPDF_SIGNATURE>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FPDF_SIGNATURE: 0x{_pointer:X16}";
}