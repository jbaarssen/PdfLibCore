...
public struct FS_LPPOINTF : IHandle<FS_LPPOINTF>
{
    private IntPtr _pointer;
    public bool IsNull => _pointer == IntPtr.Zero;
    public static FS_LPPOINTF Null => new();
    private FS_LPPOINTF(IntPtr ptr) => _pointer = ptr;
    FS_LPPOINTF IHandle<FS_LPPOINTF>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FS_LPPOINTF: 0x{_pointer:X16}";
}