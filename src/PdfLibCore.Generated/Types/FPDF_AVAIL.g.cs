...
public struct FPDF_AVAIL : IHandle<FPDF_AVAIL>
{
    ...
    public static FPDF_AVAIL Null => new();
    private FPDF_AVAIL(IntPtr ptr) => _pointer = ptr;
    FPDF_AVAIL IHandle<FPDF_AVAIL>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FPDF_AVAIL: 0x{_pointer:X16}";
}