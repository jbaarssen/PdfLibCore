...
public struct FPDF_BYTESTRING : IHandle<FPDF_BYTESTRING>
{
    private IntPtr _pointer;
    public bool IsNull => _pointer == IntPtr.Zero;
    public static FPDF_BYTESTRING Null => new();
    private FPDF_BYTESTRING(IntPtr ptr) => _pointer = ptr;
    FPDF_BYTESTRING IHandle<FPDF_BYTESTRING>.SetToNull() => new(Interlocked.Exchange(ref _pointer, IntPtr.Zero));
    public override string ToString() => $"FPDF_BYTESTRING: 0x{_pointer:X16}";
}